...
**[Stateset](https://stateset.io)** is a blockchain protocol that provides a common base for decentralized financing. The Stateset blockchain leverages liquidity from other IBC enabled blockchains for purchase order financing and invoice factoring. IBC Contracts and CW721 allow for tokenized real world assets to be collateralized via CosmWasm.
