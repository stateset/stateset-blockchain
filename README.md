...
**[Stateset](https://stateset.io)** is a blockchain protocol for decentralized commerce finance (DeComFi). Non-custodial liquidity pools using the STATE token are used for purchase order financing and invoice factoring where users can participate as lenders or borrowers. 
