...
import (
	...
	tutils "github.com/stateset/stateset-blockchain/x/auth/client/utils"
)
...
$ statesetcli tx estimate-fee [file] --gas-adjustment 1.4 --gas-prices 0.015uluna
`),
	...
	cmd.Flags().String(flags.FlagGasPrices, "", "Gas prices to determine the transaction fee (e.g. 10ustate)")
