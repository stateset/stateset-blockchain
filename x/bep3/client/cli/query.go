...
Example:
$ stcli q bep3 swaps --involve=stateset1l0xsq2z7gqd7yly0g40y5836g0appumark77ny
$ stcli q bep3 swaps --expiration=280
$ stcli q bep3 swaps --status=(Open|Completed|Expired)
$ stcli q bep3 swaps --direction=(Incoming|Outgoing)
$ stcli q bep3 swaps --page=2 --limit=100
`,
		),
		RunE: func(cmd *cobra.Command, args []string) error {
