...
func NewDefaultPubKeyGetter(keeper keeper.Keeper) statesettypes.PubKeyGetter {
	return func(ctx sdk.Context, msg statesettypes.StatesetMsg) (pubKey cryptotypes.PubKey, err error) {
...
func NewModulePubKeyGetter(keeper keeper.Keeper) statesettypes.PubKeyGetter {
	return func(ctx sdk.Context, msg statesettypes.StatesetMsg) (pubKey cryptotypes.PubKey, err error) {
