...
$ statesetcli instantiate 1 '{"arbiter": "stateset~~"}'
You can also instantiate it with funds
$ statesetcli instantiate 1 '{"arbiter": "stateset~~"}' "1000000ustate"
`,
...
the new code.
$ statesetcli tx wasm migrate stateset... 10 '{"verifier": "stateset..."}'
		`),
...
$ statesetcli tx wasm update-owner stateset... stateset...
		`),
